...
function display(response){
    ...
    <div class="box-header d-flex justify-content-between align-items-center">
        <div class="today">${response.forecast.forecastday[0].is_day}</div>
        <div class="date">${response.forecast.forecastday[0].date}</div>
    </div>
    <div class="box-body p-4 h-100">
        ...
        <div class="temp-degree">
            ...
            <img src="${response.current.condition.icon}" class="ms-3" alt="">
        </div>
        <p class="mb-4 mt-3">${response.current.condition.text}</p>
        <div class="info">
            <span class="me-2">
                <img src="image/icon-umberella.png" class="me-1" alt="">20%
            </span>
            <span class="me-2">
                <img src="image/icon-wind.png" class="me-1" alt="">18km/h
            </span>
            <span class="me-2">
                <img src="image/icon-compass.png" class="me-1" alt="">East
            </span>
        </div>
    </div>
</div>
    ...
    for(let i=1 ;i<response.forecast.forecastday.length ;i++){
        ...
        <div class="weather-box col-lg-4">
            <div class="box-header mx-auto">
                <div class="today text-center">${response.forecast.forecastday[i].date}</div>
            </div>
            <div class="box-body py-5 mx-auto">
                <div class="icon text-center mt-2 mb-4">
                    <img src="http:${response.forecast.forecastday[i].day.condition.icon}" alt="">
                </div>
                <div class="temp-degree">
                ...
                <p class="text-center mt-3">${response.forecast.forecastday[i].day.condition.text}</p>
            </div>
        </div>
        `
    }
